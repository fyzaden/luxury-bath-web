...
export default async function Home({
  ...
  return (
    <main className='relative bg-black font-sans'>
      ...
      <section className='py-20 md:py-32 px-6 bg-brand-black border-t border-white/5'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-7xl mx-auto'>
          {[
            ...
            >
              ...
              <div className='text-3xl md:text-4xl mb-6 transition-all duration-500 md:grayscale md:group-hover:grayscale-0 group-hover:scale-110'>
                {item.icon}
              </div>
